...
[![Version](https://img.shields.io/badge/version-2.9.3--AI-2E5FA3?style=flat-square)](https://github.com/fly380/fly-cms/releases)
...
|--------|---------------|
| **2.9.3-AI** | Плагін Language Translator (10 мов, navbar/footer/floating, кеш, прогрес-бар), кнопка scroll-to-top, підключення плагінів у публічній частині |
