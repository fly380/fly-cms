                ...
                <div class="form-section">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" 
                               ...
                               name="cms_version" 
                               class="form-control" 
                               value="<?php echo htmlspecialchars($settings['cms_version'] ?? '2.8.0-AI'); ?>" 
                               placeholder="1.0.0">
...
2.6.5-AI - SMTP-пароль та пароль phpLiteAdmin перенесені з коду у .env (змінні SMTP_PASSWORD, PHPLITEADMIN_PASSWORD). Секрети більше не зберігаються у файлах репозиторію.

2.6.4-AI - додано файловий менеджер з можливістю прямого редагування файлів.

2.6.3-AI - додано керування резервним копіюванням баз данних і файлової системи.

2.6.2-AI - додано нотатки у адмінці.

2.6.1-AI - додано функцію запрошення для реєстрації.

2.6.0-AI - додано двофакторну автентифікацію 2FA через Google Authenticator або Authy.

2.5.3-AI - додано можливість створення випадаючого меню.

2.5.2-AI - додано можливість виводити обрані записи на головній сторінці в розділі "новини".

2.5.1-AI - Додано можливість вести Блог — Записи.

2.5-AI - Додано Медіа бібліотеку. Автоматична транслітерація назв файлів з кириличних в латину, з додаванням короткого хешу. Обрізання назви файлу до 50 символів.

2.0.4-AI - Додано плагін для автоматичної транслітерації назви сторінок в латину.

2.0.3-AI - Оптимізовано меню під мобільні пристрої.

2.0.2-AI - Додано можливість підключати до сторінок користувацькі стилі і скрипти (лише адміністратору).

2.0.1-AI - Встановлено час життя сесії після закриття браузера. Додано session_regenerate_id(true) після входу для безпеки. Очищення сесії та cookie при виході (logout.php).

2.0-AI - Інтегровано ШІ-помічника (🤖) для генерації контенту. Розширено редактор сторінок підтримкою штучного інтелекту.

1.9 - Додано роль "редактор" з обмеженим доступом.

1.8.9 - Додано drag-and-drop редагування пунктів меню в редакторі меню. Пункти меню зберігаються в SQLite з полем visibility_role (user/admin). Підтримка вкладених (каскадних) меню.

1.8.4 - Додано підтримку Google reCAPTCHA v3 для входу. Можливість вмикати/вимикати reCAPTCHA з налаштувань.

1.8.0 - Покращення безпеки сесій: session.cookie_httponly, secure, samesite=Lax. Генерація CSRF-токенів у формах. Обмеження кількості спроб входу.

1.7.0 - Перехід із JSON на SQLite для зберігання сторінок. Міграція існуючих сторінок у database.sqlite.

1.6.0 - Сторінки мають статус: опубліковано / чернетка. Додано параметр видимості сторінки за ролями.

1.5.0 - Налаштування сайту: додано редактор заголовку, мета-тегів, футера. Додано завантаження логотипу, favicon, фонового зображення.

1.4.0 - Можливість редагування та видалення сторінок. Підтримка чернеток і прихованих сторінок. Обмеження доступу лише для авторизованих.

1.2.0 - Розмежування прав: адміністратор і звичайний користувач. Додано логування дій користувачів: вхід, вихід, створення сторінки. Додано базове навігаційне меню.

1.0.0 - Початковий реліз fly-CMS. Проста авторизація через login.php із локальними обліковими записами. Збереження сторінок у форматі JSON. Створення HTML-сторінок із заголовком і вмістом.';
echo htmlspecialchars($settings['cms_changelog'] ?? $defaultChangelog);
?></textarea>
                        <div class="form-text">
